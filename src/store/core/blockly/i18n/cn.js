...
function initBlocklyMsg(Blockly) {
  ...
  Blockly.Msg.CATEGORY_SETTING = '设置';
  Blockly.Msg.CATEGORY_GRIPPER = '夹子';
  Blockly.Msg.CATEGORY_FITTING = '配件';
...
// Gripper
  Blockly.Msg.GRIPPER_ENABLE = '是否使用夹子';
  Blockly.Msg.GRIPPER_SPEED = '机械爪速度';
  Blockly.Msg.GRIPPER_POSITION = '机械爪位置';
  Blockly.Msg.SET_GRIPPER = '设置机械爪';
  Blockly.Msg.GRIPPER_MODE = '机械爪模式';
// GPIO
  Blockly.Msg.GET_GPIO_ANALOG = '获取模拟IO';
  Blockly.Msg.SET_GPIO_ANALOG = '设置模拟IO';
  Blockly.Msg.GET_GPIO_DIGITAL = '获取数字IO';
  Blockly.Msg.SET_GPIO_DIGITAL = '设置数字IO';
  Blockly.Msg.GPIO_EVENT_DIGITAL_PREFIX = '当数字IO';
  Blockly.Msg.GPIO_EVENT_DIGITAL_MAIN = '为'
  Blockly.Msg.GPIO_EVENT_DIGITAL_LOW = '低电平';
  Blockly.Msg.GPIO_EVENT_DIGITAL_HIGH = '高电平';
  Blockly.Msg.GPIO_EVENT_DO = '时执行';
// Text
  Blockly.Msg.TEXT_CONSOLE = '控制台打印';
  Blockly.Msg.TEXT_REMARK = '备注';
  Blockly.Msg.TEXT_MESSAGE = '消息提示';
// Loop
...
// Blockly Grove Light Sensor
  ...
  Blockly.Msg.setting = {
    ...
    tcp_offset: '设置末端偏移',
    weight: '重量(kg)',
    center_of_gravity_x: '重心(mm) X',
    center_of_gravity_y: 'Y',
    center_of_gravity_z: 'Z',
    gravity_direction: '设置负载方向',
    direction_of_gravity_x: '方向 X',
    direction_of_gravity_y: 'Y',
    direction_of_gravity_z: 'Z',
    collision_sensitivity: '设置碰撞灵敏度',
    teach_sensitivity: '设置示教灵敏度',
    save_config: '保存配置',
    restore_default_config: '重置默认配置',
  }
  ...
  Blockly.Msg.motion = {
    ...
    speed: '设置坐标速度:',
    acceleration: '设置坐标加速度:',
    anglespeed: '设置关节速度:',
    angleacceleration: '设置关节加速度:',
    speedUnit: 'mm/s',
