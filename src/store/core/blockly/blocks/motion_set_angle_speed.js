...
mBlockly.JavaScript.set_angle_speed = (block) => {
...
mBlockly.Blocks.set_angle_speed = {
  init() {
    this.appendValueInput('speed')
      .setCheck('Number')
      .appendField(Blockly.Msg.motion.anglespeed);
    this.appendDummyInput()
      .appendField(Blockly.Msg.motion.angleSpeedUnit);
    // this.appendDummyInput()
